...
public class FoodOrderStepDef {
    ...
    public void user_sends_e_mail_address_which_are_and_to_the_invite_list(String email, String email2) throws InterruptedException {
    webOrderFoodOrderPage.sendInviteList(email,email2);
    }
    @When("User chooses the delivery address {string} and validate the address {string}")
    public void user_chooses_the_delivery_address_and_validate_the_address(String deliveryOption, String address) throws InterruptedException {
